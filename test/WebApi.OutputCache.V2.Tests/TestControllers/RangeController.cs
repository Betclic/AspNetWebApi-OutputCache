...
namespace WebApi.OutputCache.V2.Tests.TestControllers
{
    ...
    public class RangeController : ApiController
    {
        ...
        [EnableRangeAttribute]
        public IEnumerable<int> Get1000_c100_s100()
        {
    ...
    //https://github.com/aliostad/EntityRange/blob/master/src/EntityRange.Server/EnableRangeAttribute.cs
    public class EnableRangeAttribute : ActionFilterAttribute
    {

        private Type _elementType;
        private RangeHeaderValue _requestRangeHeader;
        public const string EnityRangeUnit = "x-entity";
